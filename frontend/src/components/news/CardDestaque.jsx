    ...
    <div className="w-full flex flex-row gap-6 bg-[var(--cor-surface)] border border-[var(--borda)] rounded-xl p-[9px_24px_9px_9px] h-[243px]">
      ...
      <div className="flex flex-col justify-between flex-1 py-1">
        <div className="flex flex-col gap-2">
          <h2 className="text-[var(--cor-texto-titulo)] font-semibold text-xl leading-snug">
            {noticia.titulo}
          </h2>
          <p className="text-[var(--cor-texto-descricao)] text-sm leading-relaxed line-clamp-3">
            {noticia.resumo}
          </p>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm text-[var(--cor-texto-descricao)]">
